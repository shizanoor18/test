...
//$config['base_url']	= 'http://dinehome.no/';
if (strpos($_SERVER['HTTP_HOST'], '.') > 0 && $_SERVER['HTTP_HOST'] != '192.168.100.50'  && $_SERVER['HTTP_HOST'] != '192.168.10.50')
{
	$localname='';
}
else
...
|
*/
$config['encryption_key'] = 'dsfaa$fada,dfd44';
