...
define('STATIC_FRONT_IMAGE', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/image/');

define('STATIC_FRONT_CSS2', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/css2/');
define('STATIC_FRONT_JS2', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/js2/');
define('STATIC_FRONT_IMAGE2', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/images2/');

define('STATIC_FRONT_CSS3', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/css3/');
define('STATIC_FRONT_JS3', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/js3/');
define('STATIC_FRONT_IMAGE3', $prefix.'://'.$_SERVER['HTTP_HOST'].'/'.$localname.'static/front/theme1/images3/');
...
define('DEFAULT_PACKAGES', 'user.png');
...
define('ACTUAL_FEATURE_IMAGE_PATH', 'uploads/feature/actual_images/');
define('LARGE_FEATURE_IMAGE_PATH', 'uploads/feature/large_images/');
define('MEDIUM_FEATURE_IMAGE_PATH', 'uploads/feature/medium_images/');
define('SMALL_FEATURE_IMAGE_PATH', 'uploads/feature/small_images/');

define('ACTUAL_PARTNERS_IMAGE_PATH', 'uploads/feature/actual_images/');
